...
const Footer = ()=> {
    return(
     <div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
        ...
        <p className="py-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi ut, saepe totam quibusdam iste voluptates facere neque impedit animi quia accusamus nisi optio maiores. Facere alias vitae nostrum laudantium distinctio!</p>
        ...
        <div className="lg:col-span-2 flex justify-between mt-6 ">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li className="py-2 text-sm cursor-pointer">Documention</li>
